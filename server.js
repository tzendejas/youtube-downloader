  ...
  <body>
      ...
      <div class="main-card">
        ...
        <div class="quality-group">
          ...
          <div class="quality-buttons">
            <div class="quality-btn" data-quality="best">Best</div>
    ...
    <script>
      ...
      const downloadServices = {
        ...
        linkedin: (url) => 'https://linkedin-video-downloader.com/?url=' + encodeURIComponent(url),
        reddit: (url) => 'https://redditsave.com/?url=' + encodeURIComponent(url),
      ...
      videoUrlInput.addEventListener('paste', (e) => {
        setTimeout(() => {
          ...
          if (url) {
            ...
            // Auto-download if URL looks valid
            if (detected !== 'auto' && url.length > 20) {
      ...
      // Auto-select first quality button
      if (qualityBtns.length > 0) {
        selectedQuality = qualityBtns[0].dataset.quality;
        updateActiveQuality(selectedQuality);
      }
      ...
      navigator.clipboard.readText().then(text => {
        if (text && (text.includes('http://') || text.includes('https://'))) {
          if (text.includes('youtube') || text.includes('facebook') || text.includes('tiktok')) {
            videoUrlInput.value = text;
            const detected = detectSite(text);
            siteTypeSelect.value = detected;
            updateActiveCard(detected);
          }
        }
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  ✅ Fixed: Clickable site cards
  ✅ Fixed: Quality selection
  ✅ Added: Zoom, Google Meet, Vimeo
  ✅ Added: Auto-download on paste
  =========================================
  `);
});